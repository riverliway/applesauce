...
export interface WebsocketContext {
   ...
   */
  startSimulation: (simType: 'simple' | 'complex', width: number, height: number, numBots: number) => void
  /**
...
export const WebsocketProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const value = {
    register,
    unregister,
    startSimulation: (simType: 'simple' | 'complex', width: number, height: number, numBots: number) => {
      sendWsMessage({
